...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupYALTabBarController(){
        ...
        //tabBarController = self.window.rootViewController

//        var item1: YALTabBarItem
//        var image1 = UIImage(named: "nearby_icon")
...
//        tabBarController.tabBarView.tabBarItemsEdgeInsets = YALTabBarViewItemsDefaultEdgeInsets;
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "raquel.nyc.GoGreen" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("GoGreen", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("GoGreen.sqlite")
